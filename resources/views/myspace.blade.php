    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            @foreach ($breadcrumb as $crumb)
                ...
                @else
                    <li class="breadcrumb-item">
                        <a href="{{ route('myspace.subfolder', ['path' => $crumb['path']]) }}" class="text-dark text-decoration-none">
                            {{ $crumb['name'] }}
                        </a>
                    </li>
                @endif
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        ...
        try {
            ...
            console.log('Folders:', folders); // Debug
            ...
            if (folders.length === 0) {
                ...
                folders.forEach(folder => {
                    ...
                    // PERBAIKAN: Konstruksi path yang benar untuk nested folders
                    const folderPath = currentPath ? `${currentPath}/${folder.id}` : folder.id.toString();
